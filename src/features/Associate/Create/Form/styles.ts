...
import { Input as InputComponent, InputAs } from '@/components/Form/Input'

import type { FormProps } from './validator'

export const Form = styled.form([
  tw`flex flex-col w-full h-full max-w-content gap-4`,
])
